...
%\section{Den fullständiga versionen av problemen}
    ...
    \includepdf[templatesize={210mm}{390mm}, noautoscale=true, pages=1, scale=1, pagecommand=\section{Den fullständiga versionen av problemen}\subsection{Fermiproblem}]{Appendix/Problem/Fermi.pdf}
    \label{app:problemen}
...
%\section{Presentationerna tillhörande problemen}
    ...
    \includepdf[scale=0.95, pagecommand=\section{Presentationerna tillhörande problemen}\subsection{Fermiproblem}]{Appendix/Presentationer/Fermi.pdf}
    
    %\subsection{Flygplan}
    \includepdf[scale=0.95,pagecommand=\subsection{Flygplan}]{Appendix/Presentationer/Flygplan.pdf}
    ...
    %\subsection{Fritt fall}
    \includepdf[scale=0.95,pagecommand=\subsection{Fritt fall}]{Appendix/Presentationer/Frittfall.pdf}
    \includepdfmerge[nup=1x2] {Appendix/Presentationer/Frittfall.pdf, 2-3}
    
    %\subsection{Försvåring av en ekvation}
    \includepdf[scale=0.95,pagecommand=\subsection{Försvåring av en ekvation}]{Appendix/Presentationer/Ekvation.pdf}
    \includepdfmerge[nup=1x3] {Appendix/Presentationer/Ekvation.pdf, 2-4}
        
    %\subsection{Matematisk modell för bil och löpare}
    \includepdf[scale=0.95,pagecommand=\subsection{Matematisk modell för bil och löparen}]{Appendix/Presentationer/Lopare.pdf}
    \includepdfmerge[nup=1x2] {Appendix/Presentationer/Lopare.pdf, 2-3}
    \includepdfmerge[nup=1x2] {Appendix/Presentationer/Lopare.pdf, 4-5}
    
    %\subsection{Sortera en kortlek}
    \includepdf[scale=0.95,pagecommand=\subsection{Sortera en kortlek}]{Appendix/Presentationer/Sortera.pdf}
