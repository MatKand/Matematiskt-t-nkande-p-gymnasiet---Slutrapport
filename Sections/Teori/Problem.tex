...
\textcolor{WildStrawberry}{
    ...
    \label{sec:modellering}
        \textcolor{lila}{Att kunna översätta ett problem i matematiska modeller är en viktig kunskap att besitta i många olika sammanhang, även i arbetslivet~\ref{TheElephant}. Det är också minst lika viktigt att kunna granska en modell med kritisk blick, och fundera på i vilka sammanhang den gäller och när den leder till orimliga resultat.}